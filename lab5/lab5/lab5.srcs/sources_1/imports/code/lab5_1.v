...
module adder(
    ...
    ////////////////////////
    wire [3:0] sum, half_carry1, half_carry2;
    wire [4:0] intermediate_carrys;
    assign intermediate_carrys[0] = c_in;
    assign sum = x ^ y;
    assign half_carry1 = x & y;
...
module arithmeticUnit(
    ...
    wire [3:0] b_input;
    assign b_input = x;
    adder add(a_mux_out, b_input, c_in, out, c_out);
    ////////////////////////
